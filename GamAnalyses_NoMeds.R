#########################################
#### GAM MODELS FOR SENSITIVITY DATA ####
#########################################

#Load data
data.NMF <- read.csv("/data/joy/BBL/projects/pncPreterm/subjectData/n243_Prematurity_allData_NoPsychMeds.csv", header=TRUE, na.strings = "NA")
