...
nmfData <- read.csv("/data/joy/BBL/projects/pncPreterm/subjectData/NmfResults26Bases_bblids.csv", header=TRUE)
...
### SAVE DATA ###
#################
write.csv(dataComb1, file="/data/joy/BBL/projects/pncPreterm/subjectData/n278_Prematurity_allData.csv", row.names=FALSE)
write.csv(dataComb2, file="/data/joy/BBL/projects/pncPreterm/subjectData/n243_Prematurity_allData_NoPsychMeds.csv", row.names=FALSE)
